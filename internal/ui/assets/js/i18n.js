...
const zhCN = {
  ...
  settings: "设置",
  settingsTitle: "设置",
  settingsSubtitle: "管理 conduct 的语言和界面外观。",
  settingsLanguageHint: "控制 CLI 与浏览器中的产品文案语言。",
  settingsThemeHint: "控制浏览器界面的颜色主题。",
...
const en = {
  ...
  settingsSubtitle: "Manage language and appearance for conduct.",
  settingsLanguageHint: "Controls the language of product copy in the CLI and browser.",
  settingsThemeHint: "Controls the browser interface color theme.",
